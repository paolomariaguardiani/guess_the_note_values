###################################################################
#                                                                 #
# http://www.codeskulptor.org/#user43_3KjyZWNNGD_19.py             #
#                                                                 #
...
def draw(canvas):
    ...
    canvas.draw_text(domanda_2, (60, 180), 40, "Yellow")
    canvas.draw_text(domanda_3, (60, 140), 40, "Yellow")
    canvas.draw_text(domanda_3_a, (60, 180), 40, "Yellow")
