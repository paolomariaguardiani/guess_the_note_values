###################################################################
#                                                                 #
# http://www.codeskulptor.org/#user43_3KjyZWNNGD_24.py            #
#                                                                 #
...
def draw(canvas):
    ...
    canvas.draw_text("Risposte corrette = " + str(click_corretti), (20, 660), 20, "Blue")
    canvas.draw_text("Risposte sbagliate = " + str(click_sbagliati), (200, 660), 20, "Blue")
    canvas.draw_text("Prove effettuate" + str(click_corretti + click_sbagliati), (400, 660), 20, "Blue")
