###################################################################
#                                                                 #
# http://www.codeskulptor.org/#user43_3KjyZWNNGD_20.py             #
#                                                                 #
...
def prova_01():
    global domanda_1, domanda_2, domanda_3, radius, riquadro, colore_2
    radius = 1
...
def prova_03():
    global domanda_1, domanda_2, domanda_3, domanda_3_a, radius
    radius = 1
...
def draw(canvas):
    ...
    canvas.draw_text(domanda_1, (60, 180), 40, colore_1)
    canvas.draw_text(domanda_2, (60, 180), 40, colore_2)
    canvas.draw_text(domanda_3, (60, 140), 40, colore_3)
    canvas.draw_text(domanda_3_a, (60, 180), 40, colore_3)
