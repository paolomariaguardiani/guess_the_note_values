###################################################################
#                                                                 #
# http://www.codeskulptor.org/#user43_3KjyZWNNGD_25.py            #
#                                                                 #
...
def calcola_voto():
    ...
    if click_corretti != 0:
        return prove_totali * 10 / click_corretti
...
def draw(canvas):
    ...
    #canvas.draw_text("Voto della prova = "  + str(calcola_voto()), (700, 660), 20, "Lime")
